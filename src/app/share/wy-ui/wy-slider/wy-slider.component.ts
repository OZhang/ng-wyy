...
import { tap, map, distinct, distinctUntilChanged, takeUntil, pluck, filter } from 'rxjs/operators';
...
import { getElementOffset, getPercent } from 'ng-zorro-antd';
...
export class WySliderComponent implements OnInit, OnDestroy, ControlValueAccessor {
  ...
  ngOnInit() {
    ...
    this.createDraggingObserables();
    this.subscribeDrag(['start']);
  }
  private createDraggingObserables() {
  ...
  private updateTrackAndHandles() {
    ...
    // console.log("updateTrackAndHandles, this.offset", this.offset);
    this.cdr.markForCheck();
  }
